      ...
      <Dialog open={isModalVisible}>
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Cadastre o mesmo número de telefone que você já usa pra falar com seus clientes.
            </DialogDescription>
          </DialogHeader>
          <form className="grid gap-4 py-4" onSubmit={onSubmit}>
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input isPhoneNumber name="phone" className="col-span-3" required autoComplete="off" error={errors} />
            </div>
            <DialogFooter>
              <Button type="submit" variant={'highlight'} size={'sm'} disabled={isLoading}>
