	...
	return (
		<main className="flex flex-col h-screen w-screen justify-start items-center align-middle bg-[#FFEAD7]">
			<section className="flex flex-col max-lg:z-10 absolute mt-[180px] lg:mt-[130px] max-lg:mt-[80px] w-[70%] max-lg:w-auto items-center align-middle text-center left-3 space-y-5">
				...
				<Text
					type="h1"
					className="text-primary lg:text-[50px] text-[70px] font-semibold"
				>
				...
				<Text type="h3" className="flex flex-col w-[60%] lg:w-[70%]">
					<span>
						Um sistema simples e eficiente que permite enviar mensagens,
						gerenciar seus contatos e aumentar suas vendas com{' '}
						<span className="bg-chart-4">muita facilidade</span>.
						<p />
					</span>
					<span className="mt-2">
						Cadastre seu telefone, adicione os contatos, crie sua mensagem e
						pronto! Agende o envio no melhor horário para você e acompanhe os
